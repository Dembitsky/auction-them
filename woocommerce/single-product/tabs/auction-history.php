...
<table id="auction-history-table-<?php echo esc_attr( $product->get_id() ); ?>" class="auction-history-table">
    ...
    <?php 
        ...
        <thead>
            <tr>
                <th><?php esc_html_e('Laiks', 'wc_simple_auctions') ?></th>
                <th><?php esc_html_e('Dalībnieks', 'wc_simple_auctions') ?></th>
                <th><?php esc_html_e('Solis', 'wc_simple_auctions') ?></th>
            </tr>
        </thead>
        <tbody>
